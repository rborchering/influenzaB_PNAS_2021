...
of_ga <- function(x) {
  ...
  of_2019(par = c(R0_A = x[1], amplitude_A = x[2], rho_A = x[3]),
          est = est_these, pomp_object = po_2019_trunc, params_all_int = params_all_2019_neut, 
          target_data = inc_data_2_trunc, fit = "A")
}
...
result_neutral_2019_3p_A_trunc <- list(it_took  = c(paste((ga_took$toc - ga_took$tic)/3600, "hrs"), 
...
save(result_neutral_2019_3p_A_trunc, file = "result_neutral_2019_3p_A_trunc.Rdata")
